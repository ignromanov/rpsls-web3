...
const ShareIcon = React.memo((props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
const HandRaisedIcon = React.memo((props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
const ClockIcon = React.memo((props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
const EyeIcon = React.memo((props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export { HandRaisedIcon, ClockIcon, EyeIcon, MetamaskIcon, SpinnerIcon };
